...
export const emailVariables=new Set(['participant.first_name','participant.full_name','organization.name','event.name','event.start_date','event.location','event.public_url','event.participant_url','certificate.url']);
