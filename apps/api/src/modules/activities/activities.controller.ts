...
export class ActivitiesController {
  ...
  @Get('organizations/:organizationId/game-sessions/:id/details') details(@CurrentUser() u: AuthenticatedUser, @Param('organizationId') o: string, @Param('id') id: string) { return this.activities.details(u.id, o, id); }
