...
export class AssessmentsController {
  ...
  @Get('organizations/:organizationId/assessments/:id/submissions') submissions(@CurrentUser() u: AuthenticatedUser, @Param('organizationId') o: string, @Param('id') id: string) { return this.assessments.submissionDetails(u.id, o, id); }
