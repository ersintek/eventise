export const updates = [
  ...
  },
  {
    ...
    changes: [
      ...
      ['Etkinlik Bilgileri, Başvurular, İletişim, Katılım ve Sonuçlar gibi bölüm adları ürün genelinde daha kısa ve gündelik bir dille standartlaştırıldı.', 'Aynı işlemi her ekranda aynı adla tanıma'],
      ['Etkinlik durumu Taslak veya Yayında; kayıt formu durumu Açık veya Kapalı olarak birbirinden ayrıldı.', 'Etkinlik sayfası ile başvuru kabulünü birbirinden bağımsız yönetme'],
      ['Kayıt formunun yalnızca yayındaki bir etkinlikte açılabilmesi güvence altına alındı ve geçersiz durum değişiklikleri anlaşılır biçimde engellenmeye başladı.', 'Katılımcıya hazır olmayan bir formu yanlışlıkla açmama'],
      ['Yayın ve kayıt formu işlemlerine bekleme, başarı ve hata bildirimleri eklendi; güncel durum işlemden hemen sonra görünür hâle geldi.', 'İşlemin tamamlanıp tamamlanmadığını açıkça görme'],
      ['Başvurular için toplam, bekleyen, kabul edilen, kalan yer ve kontenjan doluluk bilgilerini bir araya getiren yeni bir özet alanı hazırlandı.', 'Başvuru durumunu tek bakışta değerlendirme'],
      ['Başvurular tümü, bekleyen, kabul edilen ve yedek liste durumlarına göre filtrelenebilir hâle geldi.', 'Karar bekleyen katılımcılara daha hızlı odaklanma'],
      ['Kabul, ret ve yedek liste işlemlerine yüklenme durumu ile görünür sonuç bildirimi eklendi.', 'Aynı işlemi yanlışlıkla tekrarlamadan güvenle karar verme'],
      ['Kayıt formunda ad, soyad ve e-posta değiştirilemeyen standart alanlar olarak gösterildi; özel sorular ayrı bir alanda toplanmaya başladı.', 'Zorunlu iletişim bilgilerini formdan yanlışlıkla çıkarmama'],
      ['Ek form sorularının anahtarları düzenleme sırasında korunurken soruların sıralanması, zorunluluğu ve seçenekleri daha güvenli güncellenebilir hâle geldi.', 'Mevcut yanıtlarla bağı koparmadan formu geliştirme'],
      ['SSS düzenleyicisi mobil uyumlu hâle getirildi; soruları sıralama, bağımsız güncelleme ve kaydın sonucunu görme seçenekleri eklendi.', 'SSS içeriğini diğer etkinlik bilgilerine dokunmadan yönetme'],
      ['Etkinlik sayfasına görünür bir SSS bağlantısı ve katılımcıların yanıtları rahatça tarayabileceği açılır soru alanı eklendi.', 'Sık sorulan soruların yanıtına daha kolay erişme'],
      ['Yeni etkinlik akışında duyuru metninden Otomatik Doldur ilk adıma taşındı ve çıkarılan alanlar güven düzeyine göre kontrol edilmek üzere işaretlenmeye başladı.', 'Hazır bir metinden hızla başlayıp belirsiz bilgileri gözden kaçırmama'],
      ['Otomatik Doldur; Türkçe tarihleri, saat aralıklarını, etkinlik biçimini, mekânı, adresi, çevrim içi bağlantıyı ve kontenjanı tanıyacak şekilde genişletildi.', 'Duyuru metninden daha eksiksiz bir etkinlik taslağı oluşturma'],
      ['Yeni etkinliğin görseli ve vurgu rengi son kontrol adımına alındı; oluşturma tamamlandığında etkinlik bilgilerine doğrudan geçiş eklendi.', 'Taslağı görünümüyle birlikte hazırlayıp düzenlemeye kesintisiz devam etme'],
      ['Ana sayfadaki öneri; taslak, bekleyen başvuru, kapalı kayıt formu, süren veya tamamlanan etkinlik durumuna göre sıradaki işi belirlemeye başladı.', 'O anda en önemli işe tahmin etmeden ilerleme'],
      ['Herkese açık etkinlik sayfasında durum, temel bilgiler, içerik, SSS, paylaşım ve kayıt yolları daha belirgin bir sırada yeniden düzenlendi.', 'Etkinliği ve katılım koşullarını daha rahat anlama'],
      ['Beşten fazla ek sorusu olan kayıt formları ayrı ve odaklı bir kayıt sayfasında açılmaya; form bölümleri iletişim, etkinlik soruları ve onaylar olarak gösterilmeye başladı.', 'Uzun formu telefon ve masaüstünde daha rahat tamamlama'],
      ['Ürün turu, kullanım rehberi, mobil yerleşimler ve ürün dili yeni etkinlik yaşam döngüsüne göre güncellendi; tutarsız terimleri yakalayan otomatik kontrol eklendi.', 'Yeni iş akışlarını her ekranda aynı yönlendirmeyle kullanma'],
    ],
  },
  {
    version: '0.35.0',
